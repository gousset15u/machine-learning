...
# # Create model
# model_1 = lr.LogisticRegression(0.15,1) # <-- Should work with default constructor  
...
#new_X_train = model_1.build_add(X_train)
#new_X_test = model_1.build_add(X_test)

# Fit model (TO TRAIN SET ONLY)
model_2 = lr.LogisticRegression(0.45,2)  # <--- Feel free to add hyperparameters
